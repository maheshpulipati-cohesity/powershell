### usage: ./pauseProtectionJob.ps1 -vip mycluster -username admin -protectionJobName Ajit_Test 
...
param (
    ...
    [Parameter(Mandatory = $True)][string]$protectionJobName #Name of the protection job to pause
)
...
### Pause the Protection Job

echo "Pausing $protectionJobName Protection Job...."

api post protectionJobState/$JobId @{ 'pause'= $true}
